...
import 'package:sketch_flutter_project/logic/language/language_bloc.dart'
    as _i15;
import 'package:sketch_flutter_project/logic/theme/theme_bloc.dart' as _i17;
...
import 'package:sketch_flutter_project/repositories/language_repository/language_repository.dart'
    as _i11;
import 'package:sketch_flutter_project/repositories/language_repository/language_repository_imp.dart'
    as _i12;
...
import 'package:sketch_flutter_project/repositories/token_repository/token_repository.dart'
    as _i8;
import 'package:sketch_flutter_project/repositories/token_repository/token_repository_imp.dart'
    as _i9;
import 'package:sketch_flutter_project/rest_api/user_rest_api.dart' as _i14;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i11.LanguageRepository>(
      _i12.LanguageRepositoryImp(localStorage: get<_i6.LocalStorage>()));
  await gh.factoryAsync<_i13.ThemeRepository>(
      () => repositoryModule
          .provideThemeRepository(get<_i7.ThemeRepositoryImp>()),
      preResolve: true);
  gh.factory<_i14.UserRestApi>(() => apiModule.provideUserRestApi(
      get<String>(instanceName: 'apiUrl'), get<_i10.DioProvider>()));
  gh.factory<_i15.LanguageBloc>(() =>
      _i15.LanguageBloc(languageRepository: get<_i11.LanguageRepository>()));
  gh.factory<_i16.LoginUserBloc>(() => _i16.LoginUserBloc(
      loginFormValidator: get<_i5.UserLoginFormValidator>(),
      tokenRepository: get<_i8.TokenRepository>(),
      userRestApi: get<_i14.UserRestApi>()));
  gh.factory<_i17.ThemeBloc>(
      () => _i17.ThemeBloc(themeRepository: get<_i13.ThemeRepository>()));
  return get;
}
